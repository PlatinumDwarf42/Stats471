...
model_3 = build_group_model(Group_3, all_coin_data)
...
overall_acc_full_model = c()
up_correct_full_model = c()


overall_acc_model_1 = c()
up_correct_model_1 = c()


overall_acc_model_2 = c()
up_correct_model_2 = c()


overall_acc_model_3 = c()
up_correct_model_3 = c()
...
for(i in 1:100){
  ...
  overall_acc_full_model = c(overall_acc_full_model, mean(full_model[[1]] == full_model[[2]]))
  up_correct_full_model = c(up_correct_full_model, mean(which(full_model[[2]] == 1)%in%which(full_model[[1]] ==1)))
  
  model_1 = build_group_model(Group_1, data)
  overall_acc_model_1 = c(overall_acc_model_1, mean(model_1[[1]] == model_1[[2]]))
  up_correct_model_1 = c(up_correct_model_1, mean(which(model_1[[2]] == 1)%in%which(model_1[[1]] ==1)))
  
  model_2 = build_group_model(Group_2, data)
  overall_acc_model_2 = c(overall_acc_model_2, mean(model_2[[1]] == model_2[[2]]))
  up_correct_model_2 = c(up_correct_model_2, mean(which(model_2[[2]] == 1)%in%which(model_2[[1]] ==1)))
  
  
  model_3 = build_group_model(Group_3, data)
  overall_acc_model_3 = c(overall_acc_model_3, mean(model_3[[1]] == model_3[[2]]))
  up_correct_model_3 = c(up_correct_model_3, mean(which(model_3[[2]] == 1)%in%which(model_3[[1]] ==1)))
}


cat("\nAll Overall Correct:", mean(overall_acc_full_model))
cat("\nModel 1 Overall Correct:", mean(overall_acc_model_1))
cat("\nModel 2 Overall Correct:", mean(overall_acc_model_2))
cat("\nModel 3 Overall Correct:", mean(overall_acc_model_3))


cat("\nCorrect up that were up ALl:", mean(up_correct_full_model, na.rm = TRUE))
cat("\nCorrect up that were up Model 1:", mean(up_correct_model_1, na.rm = TRUE))
cat("\nCorrect up that were up Model 2:", mean(up_correct_model_2, na.rm = TRUE))
cat("\nCorrect up that were up Model 3:", mean(up_correct_model_3, na.rm = TRUE))

hist(100*up_correct_full_model, breaks=50, main="All: Percent Correct Out of Up Predictions", xlab="Percent")
hist(100*up_correct_model_1, breaks=50, main="Model 1: Percent Correct Out of Up Predictions", xlab="Percent")
hist(100*up_correct_model_2, breaks=50, main="Model 2: Percent Correct Out of Up Predictions", xlab="Percent")
hist(100*up_correct_model_3, breaks=50, main="Model 3: Percent Correct Out of Up Predictions", xlab="Percent")
